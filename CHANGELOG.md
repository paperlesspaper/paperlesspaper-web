...
* update backend label text for development environment ([0a1c982](https://github.com/paperlesspaper/paperlesspaper-web/commit/0a1c982ef203506b19a389327c2d03270b1f5912))
...
* update version codes and add featured search functionality in ImageEditor ([98309c8](https://github.com/paperlesspaper/paperlesspaper-web/commit/98309c8c189c1c22677ee7fb1da772d1eea5aa7f))
...
* update start command structure in railpack.json for consistency ([fa7c532](https://github.com/paperlesspaper/paperlesspaper-web/commit/fa7c5324272e67d4624b375246622ec1cfbc9afd))
...
* update start command in railpack.json for consistency and clarity ([5f7a9f7](https://github.com/paperlesspaper/paperlesspaper-web/commit/5f7a9f76fd4a1f759575b87411e1613c24a7cc26))
...
* update railpack.json to streamline build commands and add .railpack.npmrc for npm configuration ([26875c9](https://github.com/paperlesspaper/paperlesspaper-web/commit/26875c9ccdc8af1076bc92d4321d1fba44c134c2))
